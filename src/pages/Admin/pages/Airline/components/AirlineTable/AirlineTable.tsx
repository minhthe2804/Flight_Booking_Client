...
import { Airline, airlineApi } from '~/apis/airLine.api'
...
export default function AirlineTable({ airlines, isLoading, onEdit, onDelete, countries }: AirlineTableProps) {
    ...
    const getDetailsMutation = useMutation({
        ...
        onSuccess: (response) => {
            // (response.data.data là object Airline chi tiết)
                            ...
                            airlines.map((airline: Airline) => (
                                ...
                                >
                                    ...
                                    <td className='px-6 py-4 whitespace-nowrap'>
                                        <img
                                            src={
                                                airline.logo_url || 'https://placehold.co/40x40/E2E8F0/94A3B8?text=Logo'
                                            }
                                    ...
                                    <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-700'>
                                        {/* Tra cứu tên quốc gia từ countryMap */}
